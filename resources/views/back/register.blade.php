...
<html>
  <head>
    ...
    <title>EEFacts.com | Registration Page</title>
  ...
  <body class="hold-transition register-page">
    <div class="register-box">
      <div class="register-logo">
        <a href="/back/index2.html"><b>EE</b>Facts.com</a>
      </div>
      ...
      <div class="register-box-body">
        ...
        <form action="/admin/register" method="post">
          <div class="form-group has-feedback">
            <input type="password" class="form-control" placeholder="Register Secret" name="register_secret">
          ...
          <div class="row">
            <div class="col-xs-8">
              <div class="checkbox icheck">
                <label>
                  <input type="checkbox" name="agree_terms"> I agree to the <a href="#">terms</a>
                </label>
              </div>
            </div><!-- /.col -->
            <div class="col-xs-4">
